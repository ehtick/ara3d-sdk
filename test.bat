...
rem
rem   <area> = all | sdk | geometry | devtools | bowerbird | domo | nuget | knownissues
...
if "%PROJ%"=="" (
  echo Unknown area "%AREA%". Valid areas: all, sdk, geometry, devtools, bowerbird, domo, nuget, knownissues
  exit /b 1
)
